...
export const SHIP_SIZE = 13;                    // Ship triangle size in pixels
export const SHIP_THRUST = 0.045;               // Acceleration per frame when thrusting
...
export const SHIP_MAX_SPEED = 7.0;              // Maximum velocity magnitude
